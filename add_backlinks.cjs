...
const links = [
  ...
  { slug: 'website-uptime-monitoring-guide-2026', title: 'Website Uptime Monitoring Guide', regex: /(website uptime monitoring( guide)?|uptime monitoring guide|uptime monitoring 2026|comprehensive monitoring guide)/ig },
